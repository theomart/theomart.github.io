...
PAGES = [
    ...
    {"src": "fr/offre.html", "url": "/offre/", "other": "/en/services/", "title": "Offre · Theo Martin",
     "description": "Audit du setup agentique, atelier intra sur votre repo, office hours. Les prix sont affichés, en euros HT."},
    ...
    {"src": "en/services.html", "url": "/en/services/", "other": "/offre/", "title": "Services · Theo Martin",
     "description": "Agentic setup audit, in-house workshop on your own repo, office hours. Prices are public, in euros excluding VAT."},
